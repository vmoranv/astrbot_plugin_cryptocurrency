...
-   🎮 **投资模拟**: 提供基于AI的加密货币投资模拟功能，支持现货和合约交易。
...
| `/cry_fight <起始资金>` | 开始投资模拟。 | `/cry_fight 10000` |
| `/cry_fight finish` | 结束投资模拟并结算。 | `/cry_fight finish` |
| `/cry_fight_status` | 查看当前投资状态。 | `/cry_fight_status` |
...
### v1.0.0
-   初始版本发布。
-   实现14个核心功能，包括实时价格、全球市场、热门趋势、历史图表、分类查询、涨跌幅榜等。
-   使用 CoinGecko 实时搜索 API，支持所有上市币种。
-   新增基于AI的投资模拟功能，支持现货和合约交易。
